...
function local() {
  ...
  function homeJackpot() {
    ...
    var start = new Date("February 1, 2023 00:00:00");
    ...
    function formatMoney(amount) {
      ...
      var cents = (Math.round((amount % 1) * 100) / 100)
        .toString()
        .split(".")[1];
  ...
  function floatingContact() {
    $(document).ready(function () {
      $("#floating-contact-widget").click(function (event) {
        event.stopPropagation();
        $(
          "#floating-contact-widget .floating-contact__item, #floating-contact-widget .btn-close"
        ).toggleClass("show-contact-info");
        $(
          "#floating-contact-widget .icons, #floating-contact-widget .static"
        ).toggleClass("hide");
      });
